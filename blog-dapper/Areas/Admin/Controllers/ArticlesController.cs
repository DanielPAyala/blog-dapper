...
public class ArticlesController : Controller
{
    ...
    public IActionResult Create([Bind("Title, Description, State, CategoryId, CreatedAt")]Article article)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public IActionResult Edit(int id, [Bind("ArticleId, Title, Content, CategoryId")] Article article)
    {
